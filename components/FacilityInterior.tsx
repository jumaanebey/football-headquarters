...
const rooms:Partial<Record<BuildingType,{src:string;alt:string}>>={
  ...
  [BuildingType.MEDICAL_CENTER]:{src:new URL('../art/rooms/rehab-room-interior-v1.webp',import.meta.url).href,alt:'Inside the Rehab Center: blue ice bath, padded treatment bench and recovery equipment'},
