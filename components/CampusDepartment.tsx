...
export function CampusDepartment({club,building,blocked,onClose,onUpgrade,onCollect,onFinishNow,onHireBuilder,onDefense,onProgram,onGameDay,onWeightRoom,onRoster,onFilmArchive,onAction,onPractice}:{
