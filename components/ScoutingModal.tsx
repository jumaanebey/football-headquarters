...
export const ScoutingModal:React.FC<Props>=({club,resources,roster,academy,onClose,onUpgrade,onFinishNow,onHireBuilder,onRoster,onAction,blocked=false})=>{
 ...
 <div className="fhq-department-controls"><FacilityUpgrade club={club} building={academy} blocked={blocked} onUpgrade={onUpgrade} onFinishNow={onFinishNow} onHireBuilder={onHireBuilder}/><ScoutingActivities club={club} blocked={blocked||!onAction} onAction={a=>onAction?.(a)}/></div><FacilityGoals building={academy}/></div></Sheet>;
};
