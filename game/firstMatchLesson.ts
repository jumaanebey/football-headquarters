export function firstMatchLesson(deployed:boolean,called:boolean,subbed:boolean,hero = {name:'The Franchise', abilityName:'Hail Mary'}) {
 ...
 return {step:3,title:'Build on the play',detail:'Your signature is called. Send support players in and take the Stadium or reach 50% overall damage to win. Partial damage counts; walls do not.'};
}
