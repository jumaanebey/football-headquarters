...
export const HERO_PLAYBOOK: Record<string, { identity: string; timing: string; lineup: string }> = {
  ...
  enforcer: { identity: 'The comeback runner', timing: 'Use Truck Stick near a target: he plants, drives forward and bursts through on contact while recovering grit.', lineup: 'Send him ahead of your ranged players.' },
