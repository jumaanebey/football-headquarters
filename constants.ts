...
export const DEFENSE_TYPES: DefenseTypeDef[] = [
  ...
  { kind: 'sled',   name: 'Tackling Sled',  sprite: '/assets/battle/tackling-sled.webp',  emoji: '🛷', desc: 'Knocks runners back; linemen resist',   cost: 1800, hp: 340, damage: 22, range: 14 },
  { kind: 'ref',    name: 'Ref Tower',      sprite: '/assets/battle/ref-tower.webp',      emoji: '🚩', desc: 'Warns, then disrupts; IQ shortens flags', cost: 3200, hp: 220, damage: 13, range: 30 },
  { kind: 'tshirt', name: 'T-Shirt Cannon', sprite: '/assets/battle/tshirt-cannon.webp',  emoji: '👕', desc: 'Area pressure — spread out to resist',       cost: 2200, hp: 240, damage: 18, range: 20 },
  { kind: 'cooler', name: 'Gatorade Station', sprite: '/assets/battle/gatorade-station.webp', emoji: '🥤', desc: 'Water slows lanes; agile players retain more speed', cost: 2800, hp: 250, damage: 8, range: 22 },
];
...
export const wallCap = (stadiumLevel: number) => Math.min(44, 22 + 2 * stadiumLevel); // castle-dense: the ring reads as a WALL, not a picket line
