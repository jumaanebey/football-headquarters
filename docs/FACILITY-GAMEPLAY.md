...
Narrow-phone production follow-up: at 319×810 the ticket-income section pushed the first kickoff button below the viewport (bottom 908px). Football now precedes gate-income controls. Native rendering at 319×811 places the same kickoff button at 699–743px and keeps building upgrades visible. This is presentation only; authority v6 is unchanged.
