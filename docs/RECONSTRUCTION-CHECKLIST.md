...
- [ ] Pending, failed, and confirmed saves/publications/attack reports are distinguishable.
- [ ] Revisioned state, durable operation IDs, retry queue, and conflict/recovery rules.
