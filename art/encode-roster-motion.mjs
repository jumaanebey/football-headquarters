...
import { readMotionBounds, writeMotionBounds } from './motion-bounds-io.mjs';
...
writeMotionBounds(bounds); // merge: QB/Enforcer bounds from art/encode-motion.mjs are preserved
