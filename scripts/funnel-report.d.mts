...
export function fetchRows(url: string, key: string, since: string, options?: { fetchImpl?: (url: string, init?: RequestInit) => Promise<{ ok: boolean; status: number; json(): Promise<unknown> }>; page?: number }): Promise<FunnelRow[]>;
